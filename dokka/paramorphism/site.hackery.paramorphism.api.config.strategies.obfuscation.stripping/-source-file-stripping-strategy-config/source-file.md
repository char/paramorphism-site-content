[paramorphism](../../index.md) / [site.hackery.paramorphism.api.config.strategies.obfuscation.stripping](../index.md) / [SourceFileStrippingStrategyConfig](index.md) / [sourceFile](./source-file.md)
