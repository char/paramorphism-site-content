[paramorphism](../index.md) / [site.hackery.paramorphism.api.config.strategies.obfuscation.kotlin](index.md) / [KotlinIntrinsicsConcealingStrategyConfig](./-kotlin-intrinsics-concealing-strategy-config.md)
