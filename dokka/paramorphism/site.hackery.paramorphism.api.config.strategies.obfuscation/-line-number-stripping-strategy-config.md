[paramorphism](../index.md) / [site.hackery.paramorphism.api.config.strategies.obfuscation](index.md) / [LineNumberStrippingStrategyConfig](./-line-number-stripping-strategy-config.md)
