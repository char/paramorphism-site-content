[paramorphism](../index.md) / [site.hackery.paramorphism.api.config.strategies.obfuscation.kotlin](index.md) / [KotlinMetadataStrippingStrategyConfig](./-kotlin-metadata-stripping-strategy-config.md)
